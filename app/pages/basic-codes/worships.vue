<template>
  <div>
    ...
    <!-- 테이블 -->
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden max-w-3xl">
...
const items = ref([
  { code: 'W001', name: '주일1부예배' },
  { code: 'W002', name: '주일2부예배' },
  { code: 'W003', name: '주일3부예배' },
  { code: 'W004', name: '수요예배' },
  { code: 'W005', name: '금요철야예배' },
  { code: 'W006', name: '새벽기도회' },
])
</script>
